                        ...
                        <div class="p-wedding-card__cotainer">
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    ...
                                    <div class="p-wedding-card__other">
                                        <a id="js-radio-pare01" class="p-wedding-card__modalForm js-pagelink js-net03" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-wedding-card__cotainer">
                            ...
                            <div class="p-wedding-card__content">
                                ...
                                <div class="p-wedding-card__block">
                                    ...
                                    <div class="p-wedding-card__other">
                                        <a id="js-radio-pare" class="p-wedding-card__modalForm js-pagelink js-net04" href="#contact">この式場に応募する</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
//   const target = new Date("2023/3/31 23:59:59"); //ターゲット日時を取得
...
// let countdown = setInterval(function () {
//   const now = new Date(); //今の日時
//   const target = new Date("2023/1/15 23:59:59"); //ターゲット日時を取得
//   const remainTime = target - now; //差分を取る（ミリ秒で返ってくる
...
//   const now = new Date(); //今の日時
//   const target = new Date("2023/1/31 23:59:59"); //ターゲット日時を取得
//   const remainTime = target - now; //差分を取る（ミリ秒で返ってくる
...
// }, 1000); //1秒間に1度処理
  ...
  // 基本の数字リストを作成します
  const numbers = [3, 4, 5]; // 表示したい数字のリスト

  // 1日=86400000ミリ秒（24時間×60分×60秒×1000ミリ秒）
  ...
  function updateNumber() {
      ...
      // 1970年1月1日から現在までの経過日数を計算
      const daysSinceEpoch = Math.floor(today.getTime() / millisecondsInDay);

      // 2日ごとのサイクルでリストのインデックスを計算
      const index = Math.floor((daysSinceEpoch % (numbers.length * 2)) / 2);
  ...
  window.onload = function() {
    // 3秒後にフェードアウト
    setTimeout(function() {
      var element = document.querySelector('.number_apply');
      element.classList.add('fade-out');

      // フェードアウトが完了した後に非表示にする（1秒後）
      setTimeout(function() {
        element.style.display = 'none';
      }, 1000); // transitionの1秒に合わせて
    }, 10000); // 表示されてから10秒後にフェードアウト開始
  }
</script>
