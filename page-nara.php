<?php get_header(); ?>
  ...
  <style>
    ...
    .p-mainview_box:after {
      content: '';
      background-image: url(https://www.otokucon.jp/wp-content/themes/otokucon/assets/images/fv_lead_nara.png);
    ...
    @media screen and (max-width: 480px) {
      .p-mainview_box:after {
        content: '';
        background-image: url(https://www.otokucon.jp/wp-content/themes/otokucon/assets/images/fv_lead_nara_sp.png);
        display: inline-block;
        width: 20%;
        height: 100%;
        background-size: contain;
        ...
        <ul>
          <li>
            <div class="reason_list_image">
              <div>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reason01_nara.jpg" alt="理由1イメージ画像">
              </div>
            </div>
            <div class="reason_list_text">
              <p class="reason_list_lead">水と緑に囲まれた広大な空間</p>
              <p class="reason_list_note">
                最新演出｢プロジェクションマッピング｣を取り入れたゲストハウス！<br>
                水と緑が溢れる広大な敷地には、開放感たっぷりの独立型ガラス張りチャペル。この人気会場でプライベートな貸切ウェディングが叶います。
              </p>
            </div>
          </li>
          <li>
            <div class="reason_list_image">
              <div>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reason02_nara.jpg" alt="理由2イメージ画像">
              </div>
            </div>
            <di class="reason_list_text">
              <p class="reason_list_lead">シェフこだわりの料理でおもてなし</p>
              <p class="reason_list_note">
                結婚式の定番の料理であるフレンチ。<br>
                だからこそ季節の食材をふんだんに使い、食器の上で宝石のように美しく盛り付けられ輝きを放つ。<br>
                究極の逸品でゲストへ感謝の想いを伝えましょう。
              </p>
            </di>
          </li>
          <li>
            <div class="reason_list_image">
              <div>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reason03_nara.jpg" alt="理由3イメージ画像">
              </div>
            </div>
            <div class="reason_list_text">
              <p class="reason_list_lead">バンケットはおふたり色に染めて</p>
              <p class="reason_list_note">
                大きな窓から差し込む自然光や緑がパノラマに広がり開放的な抜け感を演出。<br>
                天井高は9ｍ！会場全体に360度のプロジェクションマッピングが投影でき最新のサプライズ演出が可能。
              </p>
            </div>
          </li>
        </ul>
    ...
    <section class="p-contact l-contact" id="contact">
      <div class="p-contact__inner l-inner">
        ...
        <div class="p-contact__block">
          <?php echo do_shortcode('[mwform_formkey key="910"]'); ?>
        </div>
      </div>
    </section>
