...
<div class="countdown-box sp">
  ...
  <div id="countdownArea" class="countdown sp view_timer" data-end-date="2024/4/30 23:59:59">
  ...
  <div id="countdownArea" class="countdown02 sp view_timer" data-start-date="2024/5/1 00:00:00">
    <span class="countdown-tx deadline">締め切りまであと</span>
...
<div class="header_sp sp">
    ...
    <div class="fat-nav sp">
        <nav class="header-nav fat-nav__wrapper" id="js-nav">
            <ul class="nav__items nav-items nav-list" id="menu">
                ...
                <li class="nav-item nav-items__item"><a href="#voice">お客様の声</a></li>
    ...
    <div class="p-mainview l-mainview">
        <picture class="p-mainview__img">
            <source srcset="<?php echo get_template_directory_uri(); ?>/assets/images/mainview-pc.png" media="(min-width: 768px)" />
            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/mainview.png" alt="先着で20名様に！お得に叶えよう！結婚式プレゼント">
        </picture>
    ...
    <section id="wedding_hall" class="p-wedding l-wedding">
        <div class="p-wedding__inner l-inner">
            ...
            <p class="p-wedding__copy">ご希望の式場を今すぐ見学する。</p>
            ...
            <div class="p-voice__items">
                <div class="p-voice__item p-voice-card">
                    <div class="p-voice-card__body">
                        <h3 class="p-voice-card__title">子供も一緒に楽しい式ができました！<span>新婦O様</span></h3>
                        <div class="p-voice-card__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/voice-img01.jpg" alt="子供も一緒に楽しい式ができました！新婦O様">
                        </div>
                        <p class="p-voice-card__text">
                        コロナ禍で結婚式を先延ばしにしていました。 その間に
                        子供も産まれ、自分達のことは後回しにしていましたが、子供も1歳になり少しずつ落ち着いてきたときにこちらのキャンペーンをみつけました。改めて結婚式をしたい!と
                        強く思い、応募させていただきました。<br><br>
                        子育てをしながらの準備は大変なこともありましたが、<br>
                        <span>子供も楽しめるような提案も</span>してくれて、安心して準備を進めることが出来ました。きれいな式場と演出で、
                        家族や友人からも最高の式だったと言ってもらい、
                ...
                <div class="p-voice__item p-voice-card">
                    <div class="p-voice-card__body">
                        <h3 class="p-voice-card__title">妻の夢を叶えることが出来ました！<span>新郎K様</span></h3>
                        <div class="p-voice-card__img">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/voice-img02.jpg" alt="妻の夢を叶えることが出来ました！新婦K様">
                        </div>
                        <p class="p-voice-card__text">
                        昨年入籍をしましたが、金銭的な理由で結婚式はできないと、ずっと悩んでいたたところ、こちらのキャンペーンを知りました。 いつも苦労を掛けてる妻に、あこがれの結婚式をさせてあげたいと思い応募。当選し妻に報告すると大喜びしてくれて、僕も嬉しかったです。<br><br>
                        <span>担当プランナーさんもいつも楽しく優しく</span>、打ち合わせが毎回楽しみでした。妻や両親、友人たちにも感謝を伝えることができて、<span>一生の思い出</span>になりました。<br>
                        ありがとうございました！
                        </p>
                    </div>
                </div>
