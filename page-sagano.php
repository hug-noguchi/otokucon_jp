<?php get_header(); ?>
  ...
  <style>
    ...
    .p-mainview_box:after {
      content: '';
      background-image: url(https://www.otokucon.jp/wp-content/themes/otokucon/assets/images/fv_lead.png);
    ...
    @media screen and (max-width: 480px) {
      .p-mainview_box:after {
        content: '';
        background-image: url(https://www.otokucon.jp/wp-content/themes/otokucon/assets/images/fv_lead_sp.png);
        display: inline-block;
        width: 20%;
        height: 100%;
        background-size: contain;
  ...
  <main>
    ...
    <section id="reason" class="reason">
      <div>
        ...
        <p class="p-case__copy reason_lead">アール・ベル・アンジェ チャペル嵯峨野が<br class="sp"><span class="dots">選</span><span class="dots">ば</span><span class="dots">れ</span><span class="dots">る</span><span class="reason_lead_pink"><span class="reason_lead_emphasis">3</span>つの理由</span></p>
      </div>
        ...
        <ul>
          <li>
            <div class="reason_list_image">
              <div>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reason01.jpg" alt="理由1イメージ画像">
              </div>
            </div>
            <div class="reason_list_text">
              <p class="reason_list_lead">絵本の物語の世界を独り占め</p>
              <p class="reason_list_note">観光名所としても名高い、嵯峨嵐山。京都の田園風景の中に佇む可愛い一軒家がウェディングの舞台。あたたかな陽と優しい木漏れ日に満ちたガーデンにほっこり笑顔が溢れます。</p>
            </div>
          </li>
          <li>
            <div class="reason_list_image">
              <div>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reason02.jpg" alt="理由2イメージ画像">
              </div>
            </div>
            <di class="reason_list_text">
              <p class="reason_list_lead">旬の素材を使った料理でおもてなし</p>
              <p class="reason_list_note">我が家のような森の一軒家で、ガーデンの緑を眺めながら味わう料理も格別。堅苦しいマナーにとらわれず、旬の素材を使ったおもてなし料理を心ゆくまで味わってもらえます。</p>
            </di>
          </li>
          <li>
            <div class="reason_list_image">
              <div>
                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reason03.jpg" alt="理由3イメージ画像">
              </div>
            </div>
            <div class="reason_list_text">
              <p class="reason_list_lead">ゲストとの距離感が魅力のガーデン</p>
              <p class="reason_list_note">敷地内すべてを貸し切って過ごせるガーデン。デザートブュッフェやドリンクサービスなど、気取らない演出が似合うウェディングスタイルです。写真映えも抜群。</p>
            </div>
          </li>
        </ul>
      </div>
    ...
    <!-- <section class="l-contents">
      <div class="p-contact__inner l-inner">
        <h2 class="p-contact__title application_details_en">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/application-details-title.png" alt="application details">
        </h2>
        <div class="p-contact__copy">応募資格</div>
        <div class="p-contact__contents">
          <div class="p-contact__content application_details_present">
            <div class="p-contact-radio__head">
              <div class="p-contact-radio__name">プレゼント内容</div>
            </div>
            <div class="p-contact-radio__block">抽選で各式場にて5組様に結婚式をプレゼント！</div>
          </div>
          <div class="p-contact__content">
            <div class="p-contact-radio__head">
              <div class="p-contact-radio__name">応募資格</div>
            </div>
            <ul class="p-contact-radio__block application_details_qualification">
              <li>
                1. 30名様以上の披露宴･パーティーをされる方
              </li>
              <li>
                2. プレゼントさせて頂く「結婚式」に関してお打合せ時から当日のシーンの撮影等にご協力いただける方
              </li>
              <li>
                3. 2にて撮影したお写真等をHPやFacebook等の販促物で使用させていただくことをご了承いただける方
              </li>
            </ul>
          </div>
        </div>
    ...
    <section class="p-contact l-contact" id="contact">
      <div class="p-contact__inner l-inner">
        ...
        <div class="p-contact__block">
          <?php echo do_shortcode('[mwform_formkey key="611"]'); ?>
        </div>
      </div>
    </section>
