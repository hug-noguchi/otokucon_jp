...
<div class="countdown-box sp">
  ...
  <div id="countdownArea" class="countdown sp view_timer" data-end-date="2025/8/15 23:59:59">
  ...
  <div id="countdownArea" class="countdown02 sp view_timer" data-start-date="2025/8/16 00:00:00">
    <span class="countdown-tx deadline">締め切りまであと</span>
...
<div class="header_sp sp">
    ...
    <section class="p-contact l-contact" id="contact">
        <div class="p-contact__inner l-inner">
            ...
            <div class="p-contact__block">
                <?php echo do_shortcode('[mwform_formkey key="1513"]'); ?>
            </div>
        </div>
    </section>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/assets/js/script.js?ver=1.0.15"></script>
